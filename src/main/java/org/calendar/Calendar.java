...
public class Calendar {
    ...
    /**
     * Finds available time slots for a meeting between two schedules.
     *
     * @param calendar1 First person's calendar with meetings as ["start", "end"].
     * @param dailyBounds1 First person's working hours as ["start", "end"].
     * @param calendar2 Second person's calendar with meetings as ["start", "end"].
     * @param dailyBounds2 Second person's working hours as ["start", "end"].
    ...
    public List<String[]> getTimeBlocks(String[] calendar1, String[] dailyBounds1, String[] calendar2, String[] dailyBounds2, int meetingDuration) {
        ...
        return findAvailableSlots(mergedCalendar, meetingDuration, endOfWorkday);
    }
